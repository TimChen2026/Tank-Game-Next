  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ textAlign: 'center', color: '#8a8aaa', fontSize: 16, marginBottom: 24, fontFamily: "'Courier New', monospace" }}>登录</h2>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            <label style={{ color: '#8a8aaa', fontSize: 13, fontFamily: "'Courier New', monospace" }}>用户名</label>
            <input
              type="text" value={username} onChange={(e) => setUsername(e.target.value)}
              required autoComplete="username" placeholder="请输入用户名"
              style={{
        ...
        <p style={{ textAlign: 'center', color: '#6a6a8a', fontSize: 13, marginTop: 20, fontFamily: "'Courier New', monospace" }}>
          还没有账号？<a href="/register" style={{ color: '#fc9838', textDecoration: 'none' }}>立即注册</a>
        </p>
      </div>
    </div>
  );
